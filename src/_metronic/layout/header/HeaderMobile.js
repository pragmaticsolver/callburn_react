...
import MobileLogo from 'assets/images/logo-mini-md.png';
class HeaderMobile extends React.Component {
  ...
  render() {
    const {  headerMenuSelfDisplay } = this.props;
    return (
      <div
        id="kt_header_mobile"
      ...
      >
        ...
        <Topbar htmlClassService={this.props.htmlClassService} isMobile = {true}/>
