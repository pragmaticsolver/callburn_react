...
export const initLayoutConfig = {
  ...
  self: {
    ...
    logo: {
      dark: toAbsoluteUrl("/media/logos/callburn_logo.png"),
      light: toAbsoluteUrl("/media/logos/callburn_logo.png"),
      brand: toAbsoluteUrl("/media/logos/callburn_logo.png"),
      green: toAbsoluteUrl("/media/logos/callburn_logo.png")
    }
  },
  // == Portlet Plugin
  // portlet: {
